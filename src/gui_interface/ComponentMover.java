 ...
 *  moved can be a high level Window (i.e. Window, Frame, Dialog) in which case
...
public class ComponentMover extends MouseAdapter
{
	...
	private Insets edgeInsets = new Insets(1, 1, 1, 1);
	 ...
	 */
	public ComponentMover(LAN_Simulator lanSim)
	{
		cl =  new LabelAction(lanSim);
	}
	...
	private void setupForDragging(MouseEvent e)
	{
		...
		//component should detach itself from other components it might be attached to @Olawale.
		cl.separate(e);
	
		//save the location information in the label object
		if(e.getComponent() instanceof ComputerLabel){
			ComputerLabel c = (ComputerLabel) e.getComponent();
			c.setNewLocation(c.getLocation());
		}
		...
		//  Making sure auto scroll is false will allow for smoother dragging of
	...
	{		
		...
		//Component should interact with its new Location. @Olawale
		cl.interact(e);
